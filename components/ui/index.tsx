...
export function Badge({
    ...
    const variants = {
        default: "bg-green-50 text-[#35b544] border-green-100",
    ...
    return (
        <span className={cn("inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium border", variants[variant], className)}>
            {children}
        </span>
    );
}
