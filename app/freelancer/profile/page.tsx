    ...
    return (
        <div className="p-8 max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row gap-8 items-start">
                ...
                <Card className="w-full md:w-1/3 p-8 border-t-4 border-t-[#35b544]">
                ...
                <div className="flex-1 space-y-6 w-full">
                    ...
                    <Card className="p-8">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {profile.skills.map((skill: string) => (
                                <Badge key={skill} className="px-4 py-2 text-sm bg-white border-gray-200 text-gray-700 shadow-sm">
                                    {skill}
                                </Badge>
                            ))}
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <Button className="h-auto py-6 flex flex-col items-center justify-center gap-1 bg-gray-900 hover:bg-black">
                            <span className="text-xs font-bold opacity-50 uppercase">Next Step</span>
